 ...
 */
public class Mus implements EntryPoint {
	/**
    ...
    /*public void onModuleLoad() {
		...
		final Label introduceLabel = new Label();
        ...
        *//*Edit greetings*//*
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			*//**
			...
			private void greetTheGuy(String value) {
				IntroduceServiceAsync.Util.getInstance().greet(value,
						new AsyncCallback<String>() {

							@Override
							public void onFailure(Throwable ex) {
								introduceLabel.setText(ex.getMessage());
